...
import { createSectorIndex, resolveTrackSectors, updateTrackSectors, sectorMembershipTitle } from '../src/radar/sectors.js';
...
test('bundled EPWW data resolves known locations and the LOW/HIGH transition', async()=>{
  ...
  assert.match(sectorMembershipTitle(resolveTrackSectors(index,at(20.967,52.165,380))),/EPWW E HIGH \(FL365–660\)/);
});
