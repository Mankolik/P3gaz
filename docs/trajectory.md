...
The sequence appears in the existing last-hovered track sector panel, with predicted crossing levels and distance along the route. Crossing markers also appear when the route is displayed/previewed.
