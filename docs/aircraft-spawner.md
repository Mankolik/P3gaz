...
The supplied catalogue contains 184 airport pairs and 251 variants. At implementation, **157 pairs / 211 variants** are usable. The other 40 variants remain in the source but cannot be spawned with the present navigation data. Missing or ambiguous fixes, unresolved local airway connections and insufficient pre-entry fixes are reported with source line numbers.
